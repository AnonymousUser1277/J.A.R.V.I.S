...
if the task is to open any application then always use ('start application_name') for os.system and ('application_name') for os.startfile. YOU MUST USE NON-BLOCKING COMMANDS.
